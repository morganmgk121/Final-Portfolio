...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'nico');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Nico'); 
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://cssigniter.com/support/viewtopic.php?f=26&t=64');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=26');
